...
Status: **CLOSED**. The final authoritative matrix is **A–P PASS; Q
`ROW_Q_HOST_CONDITION_UNAVAILABLE`; R–V PASS** in the recorded real-host cell.
Earlier sections retain the status that was authoritative when each historical
attempt was recorded; they are not retroactively rewritten.
...
## Authoritative Phase 6.5 closure

Phase 6.5 closed on 2026-08-29 at checkpoint
`68551a667f473bc0e9f1768f3d5702bdfd6c0efb` on
`qualify/csp-host-adapter`. Closure means that every executable or available
real-host row A–P and R–V passed, Q is explicitly closed as an unavailable host
condition, all consumed failures remain preserved, and no qualification row is
open. Q is not a PASS.
...
`krita-plugin/host_tests/matrix.json`. Its `phase65_closure` object freezes the
checkpoint, final matrix, governance decisions, final and historical evidence
hashes, separately supplied operator observations, production identities, and
limitations. No second matrix was created.

### Final Row T — PASS

T-v11 is the first formal attempt to pass the governed Display Oracle V2
contract. Its classification is
`ROW_T_FORMAL_PASS_ALTERNATE_PROFILE_PREVIEW_SAMPLE_COMMIT_CONSISTENT`, and its
governance classification is `ROW_T_DISPLAY_ORACLE_V2_GOVERNANCE_ADOPTED`.
The independent real `ManagedColor` display oracle corrected a qualification
defect that had conflated target-profile component values with same-canvas
display `QColor`; production behavior did not change.

T-v11 verified alternate-profile preview, correction sample, and commit
consistency; target-profile conversion remained separate from display; one
Apply Selected caused one native transaction; target bytes, collateral state,
restoration, and lifecycle were exact; and Undo/Redo was not invoked. This is
qualification of the tested alternate RGBA/U8 profile cell only. It does not
qualify unrelated profiles, mixed-profile states, HDR, non-U8, or otherwise
unsupported states.

| T-v11 evidence | SHA-256 |
| --- | --- |
| Support | `d968147deccd8c0baab30e3432716a735ba2d8c0e0fb1946c859ced158c86779` |
| Harness | `62f55e2c8590d9239626638678f9687a8b7d24bd18e092377069b278a9428d3c` |
| Launcher | `8f449faacb1e7baa33cd4923101397785a56397ea9539072fc2bd7154dc4dbb2` |
| Bootstrap | `145797ac2e666da17f938eb0cd7672f2f0c92d15893db955e15753daaca7e650` |
| Result | `768bffeed2a988bfa98c371c60efbcaee1208a8a56377d649e16fc46abf1793a` |
| Harness entry | `5ceac4afe31c61ad87916c6fcb9e275804c0e4648c168ac32dac30c6bb3dcdb7` |
| Ownership | `44ed267f9a40a20fb42db0bcbf283ee9179e8e4f846ae536dc7e74a2b079efc9` |
| Preflight continuity | `305dd779ab8abf475f6385b66825163e5a25c99ae6a2c28ad9024f7e8e88cb1e` |
| Launcher attempt | `daf899bcfe878ae2f16b9fce0b93efd6f63120c422d31ccef68048d8d6070494` |

The attempt records `attempt_consumed_at = HARNESS_RUN_CALL_STARTED`, followed
by `HARNESS_RUN_RETURNED` and `LAUNCHER_RETURN_READY`. The separately supplied
operator crash observation is **NO**; it is not claimed to originate in formal
result JSON.

### Final Row U — PASS

U-v1 passed as
`ROW_U_FORMAL_PASS_TWO_VIEWS_ONE_WINDOW_AMBIGUOUS_CANVAS_FAIL_CLOSED`. The
controlled layout had two qualification documents and views, one active
`KisMainWindow`, the active disposable view plus inactive anchor view, and two
visible eligible `KisOpenGLCanvas2` widgets beneath the active `qwindow`.
Production `resolve_canvas_widget()` returned the exact fail-closed error:

> Krita's active canvas QWidget could not be uniquely identified; interactive
> overlays are disabled for this window/view layout.

The boundary was exact: zero target snapshot reads, worker constructions,
prediction starts, preview constructions, Apply Selected, Apply All, native
transaction loads, and document mutations. Cleanup was exact. This result does
not mean that all multiple-window layouts are unsupported; only eligible
canvases beneath the active `qwindow` participate.

| U-v1 evidence | SHA-256 |
| --- | --- |
| Support | `3f36a362a1a6115c7bec1f914396b9a60b1e805ba9eed84d703fdaf523656154` |
| Harness | `371a03492d986eb60e9f94366e17fc3ac0d356ac96b55f9af067153fe41078f4` |
| Launcher | `3db896531fd773550621a123aaf53a47b9f00ab727c50b6ebe6c90a1c6804520` |
| Bootstrap | `95d669cc1defe2f609e876c0957ee29321b5618f49aa90622c162d4295f8bc07` |
| Result | `3ae2e4be8076b6d467fb0fb34e009de16cf689367d8013d17a4cca4c1d46db46` |
| Harness entry | `90682614d4725a97378824a15b949723a5bef39a714359d4e63374acfe9e5f73` |
| Ownership | `54ba336b7692c048e52c5d4ba85880f4155e2b288cb91bd809d92ce4e9a480b9` |
| Preflight continuity | `6d985ad3de5ba7bf8b62edf698c2097f9cb72be42bd8b389f49792ba38ccb369` |
| Launcher attempt | `c5d701667a4853e1ecb7e3079f97e75bbef52f22fa8e84f92315f7efedf5695e` |

The attempt records the same required consumption and successful-return
boundaries as T-v11. The separately supplied operator crash observation is
**NO**.

### Final Row V — PASS

V uses the prospective adopted governance contract
`ROW_V_WORKER_ACTIVE_SHUTDOWN_CONTRACT_V1_GOVERNANCE_ADOPTED`. Historical
requirements required worker-active shutdown testing but did not freeze the
exact worker phase, synchronization seam, host action, or lifecycle details.
The deterministic Row-M detector boundary was adopted only as a qualification
synchronization fixture; it is not recovered historical semantics.

V-v2 passed as
`ROW_V_FORMAL_PASS_WORKER_ACTIVE_DOCKER_CLOSE_STALE_PUBLISH_SUPPRESSED`. A real
`gapfill_krita.worker.GapFillWorker` ran on a distinct real `QThread`, with its
generation registered and active at the detector boundary and completion not
yet published. The formal trigger was the real path
`GapFillDocker.close() -> GapFillDocker.closeEvent() ->
GapFillController.shutdown()`; direct `controller.shutdown()` was not
substituted.

The controller shutdown was observed once, `_shutting_down` was established,
the generation gate closed, the generation was invalidated, cancellation was
requested, and overlay/snapshot/gaps were cleared. After barrier release,
stale progress, failure, cancelled status, completed preview, and completed
regions were suppressed. Apply Selected, Apply All, native apply, and document
mutation remained zero. Worker and thread terminal state, cancellation at the
detector, `_runs` removal, empty worker registry, C++ worker/QThread deletion,
the bounded two-round `DeferredDelete` protocol, empty runtime graph, and native
module release all passed; the watchdog did not fire.

The raw Coloring evidence was exact before and after:

| Pixel evidence | Before | After |
| --- | --- | --- |
| SHA-256 | `03f71cecf7f013ab64850b8ef882b50e647d43840b1d0bf7650e64036fe25c9a` | `03f71cecf7f013ab64850b8ef882b50e647d43840b1d0bf7650e64036fe25c9a` |
| Byte count | 16,384 | 16,384 |

The document-mutation counter and native transaction count were both zero;
source and working fixtures remained byte-identical.

| V-v2 evidence | SHA-256 |
| --- | --- |
| Support | `94cc3651bd5128ef0f07c19b62cd781086fd5272fad21f08f6732aa26386b61e` |
| Harness | `9514855583deddc88d54f671dff7296b138a4f243b5c71aa51ede7994ae62520` |
| Launcher | `33e1d88d0957c6e8248e79c4b31d639787f6bc071e557bd1532e105c3ee69414` |
| Bootstrap | `5d3732fcac035e5faf32415aa84b1e819a33a43d50eb548ab80810b28dafd08c` |
| Result | `33c11bee9eaf5404f659857fbe532464ec41bbb47500cf244f67a77575d5449c` |
| Harness entry | `bc4b12171b058d4015db170545236c074de416b75a9cb796061c8ae3a50474bb` |
| Ownership | `6f7f28d74988f4d41bbf5de09c92830af464743c36a698ac60b3be76525112b9` |
| Launcher attempt | `8a7ad626cd80f063f665496d8ff41a7090f8b7f50147c85352549e746545e4b1` |

The attempt records the required consumption and successful-return boundaries.
The separately supplied operator crash observation is **NO**.

Full Krita **application close with a worker active was not formally
qualified**. V1/V2 cover docker close, docker `closeEvent`, and controller
shutdown only. Historical mentions of application close do not widen this
adopted formal scope.

### Unavailable Row Q and other limits

Row Q is closed as `ROW_Q_HOST_CONDITION_UNAVAILABLE`, not PASS. The actual
production-resolved real canvas widget DPR and screen DPR remained 1.0, DPI
remained 96, and the required real HiDPI condition was unavailable.

Canonical native CSP integration remains
`INSUFFICIENT_FOR_GAPFILL_PARITY` for the evaluated SDK/adapter combination, as
recorded in `docs/addon-phase7.md`. This independent capability failure is not
changed by Krita qualification closure.

### Historical attempts remain evidence

Closure does not sanitize the consumed attempt history. T-v1 through T-v10
remain preserved at their original statuses. In particular, T-v8 remains
`ROW_T_SEMANTIC_CORE_FAIL_COLOR_CONVERSION` with forensic classification
`ROW_T_V8_QUALIFICATION_DISPLAY_ORACLE_DEFECT`; T-v9 remains a consumed
transitional `ROW_T_PREPARING` result; and T-v10 remains
`ROW_T_SEMANTIC_CORE_FAIL_COLOR_CONVERSION` despite positive governed-V2
evidence. T-v11 is the first formal governed-V2 PASS.

V-v1 remains the consumed raw FAIL
`ROW_V_V1_FORMAL_INVOCATION_CONSUMED_HARNESS_FAIL_CORE_UNJUDGED`, with separate
forensic diagnosis
`ROW_V_V1_QUALIFICATION_POST_CORE_FIXTURE_COMPARISON_SCHEMA_DEFECT`. V1 is not
rewritten or retroactively passed.

The exact T-v1–v10 result and launcher-attempt hashes and the full V-v1 artifact
and evidence hashes are frozen in the machine-readable matrix. V-v1's principal
hashes are:

| V-v1 historical evidence | SHA-256 |
| --- | --- |
| Support | `3ab264ba361a755fd75d47df85aeced258622302fbc37fea76cefa3f9ab6e9da` |
| Harness | `40775ed7fbd07a0d068a5eafa4c0fcefffcf1678415f24bc8a1c5f84d54bd946` |
| Launcher | `3b07a5c2643cc4fc4a48842a7e2f4419f25ae4814de52c79f41fb40ba9e21a92` |
| Bootstrap | `d6cc783bcec2f50ae04c9464efdfea37ca1537732736b6b88a1b88d017580ed6` |
| Result | `bba8b3b6269b77a2a42d80d1f4f7ace7c5d7b245264afc84622d2a19e80dfdf3` |
| Harness entry | `759735ed845736e5cc9a9e16c839eaf7afb26f797574d2029e04fdeeec5d157e` |
| Ownership | `61f413d7446506741ed268652e628700675fb871524c5ad3941b1b9a02afe09e` |
| Launcher attempt | `d9a74294d7a118a9e0529f69e53d0e8e3afe540eacfc234b984ee07e3014c8db` |

### Frozen production identities

No production behavior was changed by closure preparation.

| Identity | SHA-256 |
| --- | --- |
| Production semantic | `b3812c8a00aa359097d9395b13d27e55433b311584a00e6906de0f426f5acc38` |
...
| Model sidecar | `2ccc406b1e0647499af6657877309e6a8d66ff7aebb0dd307ba0d7de306e55e5` |
| Fixture manifest | `6243be8f2a26b383ef0293bd585318c0072011ccabf959cb25f42127aba5908c` |
| Overlay production | `e9aeb11334be91f81025ea2e1b19e2cd28bbe2b3da01f80c5ec66e3c07e5a609` |
| Repaired plug-in artifact identity | `7001c1bf92aa7abb5840baf52fe07457ab06cb80074297488e67ded212ab74e2` |
| Artifact manifest | `14ab81ed4d6688a0e8a9800a032db53158e91c6094b8f7b5f88ed7e50cad2f61` |
