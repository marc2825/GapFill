...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--colored_dir", type=str, default=str(config.DATA_DIR), help="Path to the colored dataset directory")
    parser.add_argument("--line_art_dir", type=str, default=str(config.DATA_DIR), help="Path to the line art dataset directory")
