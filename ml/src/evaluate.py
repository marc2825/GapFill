...
def build_parser() -> argparse.ArgumentParser:
    ...
    gapfill_parser.add_argument("--line_art_dir", required=True, help="Directory containing line art images")
    gapfill_parser.add_argument("--colored_dir", required=True, help="Directory containing colored images")
    gapfill_parser.add_argument("--output_dir", required=True, help="Output directory for CSV, summary, patches, and visualizations")
    ...
    greedy_parser.add_argument("--line_art_dir", required=True, help="Directory containing line art images")
    greedy_parser.add_argument("--colored_dir", required=True, help="Directory containing colored images")
    greedy_parser.add_argument("--output_dir", required=True, help="Output directory for CSV, summary, patches, and visualizations")
